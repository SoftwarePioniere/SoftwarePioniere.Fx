...
//    public class RedisMessageBus2 : MessageBusBase2<RedisMessageBusOptions> {
//        private readonly AsyncLock _lock = new AsyncLock();
//        private bool _isSubscribed;

//        public RedisMessageBus2(RedisMessageBusOptions options) : base(options) { }

//        public RedisMessageBus2(Builder<RedisMessageBusOptionsBuilder, RedisMessageBusOptions> config)
