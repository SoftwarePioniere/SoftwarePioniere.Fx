...
{
    public class InMemoryMessageBus2 : MessageBusBase2<InMemoryMessageBusOptions>
    {
        private readonly ConcurrentDictionary<string, long> _messageCounts = new ConcurrentDictionary<string, long>();
        private long _messagesSent;

        public InMemoryMessageBus2() : this(o => o) { }

        public InMemoryMessageBus2(InMemoryMessageBusOptions options) : base(options) { }

        public InMemoryMessageBus2(Builder<InMemoryMessageBusOptionsBuilder, InMemoryMessageBusOptions> config)
