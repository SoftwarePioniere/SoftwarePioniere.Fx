...
//                , new InMemoryMessageBus(builder => builder.LoggerFactory(loggerFactory).TaskQueueMaxItems(int.MaxValue)), loggerFactory);
...
//        protected async Task DeleteItemAsync(IMessage message, IDictionary<string, string> state)
//        {
//            async Task DoAsync()
//            {
//                var item = await LoadItemAsync(message);
...
//        protected async Task LoadAndSaveEveryTimeAsync(IMessage message, IDictionary<string, string> state, Action<T> setValues = null)
//        {
//            var lockId = GetLockId(message);
...
//        protected async Task LoadAndSaveOnlyExistingAsync(IMessage message, IDictionary<string, string> state, Action<T> setValues = null)
//        {
//            var lockId = GetLockId(message);
